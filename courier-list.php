...
<table border="0" align="center" width="80%">
    ...
    <tr>
      <td class="LargeBlue" bgcolor="#FFFFFF" align="left"><div class="Partext1" align="center"><strong>Update Shipment (Pengiriman) </strong></div></td>
    </tr>
  </tbody></table>
  ...
  <table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF" style="height:20px;">
      ...
      <td class="newtext" bgcolor="#EDEDED" width="7%">Pengirim</td>
      <td class="newtext" bgcolor="#EDEDED" width="11%">Penerima</td>
